    ...
    >
      ...
      <a
        ...
        className={`inline-flex whitespace-nowrap py-2 px-3 text-sm font-medium text-gray-600 transition-all duration-200 ease-in-out ${
          activeLink === 'Announcements' ? 'border-b-2 border-transparent border-b-purple-600 text-purple-600' : 'text-gray-600 hover:border-b-purple-600 hover:text-purple-600'
      ...
      <a
        href="#"
        className={`inline-flex whitespace-nowrap py-2 px-3 text-sm font-semibold transition-all duration-200 ease-in-out ${
          activeLink === 'Curriculum' ? 'border-b-2 border-transparent border-b-purple-600 text-purple-600' : 'text-gray-600 hover:border-b-purple-600 hover:text-purple-600'
        }`}
      ...
      <a
        href="#"
        className={`inline-flex whitespace-nowrap py-2 px-3 text-sm font-medium text-gray-600 transition-all duration-200 ease-in-out ${
          activeLink === 'Roster' ? 'border-b-2 border-transparent border-b-purple-600 text-purple-600' : 'text-gray-600 hover:border-b-purple-600 hover:text-purple-600'
