import { MdOutlineMessage, MdOutlineLeaderboard, MdOutlineCompress, MdOutlineManageSearch, MdOutlineAnalytics, MdOutlineGrade, MdOutlineAnnouncement, MdOutlineLibraryBooks } from "react-icons/md";
