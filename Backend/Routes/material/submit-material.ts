...
async function callback({ Client, Data, Database,EmailProvider }: CommandExecuteArguments) {
    ...
    try {
        ...
        const {material_id,student_id,course_id,submission}=Data;
        ...
        await Database.executeQuery('INSERT INTO m_grade (material_id,student_id,course_id,submission) VALUES(?,?,?,?)',[material_id,student_id,course_id,submission]);
