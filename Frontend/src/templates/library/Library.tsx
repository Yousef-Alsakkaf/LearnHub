...
function Library({ children, name }: SettingsProps) {
  return (
      ...
      <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
        <div className="relative my-4 w-56 sm:hidden">
          ...
          <ul className="max-h-0 select-none flex-col overflow-hidden rounded-b-lg shadow-md transition-all duration-300 peer-checked:max-h-56 peer-checked:py-3">
            <li className={`cursor-pointer ${name == "ViewItems" ? "border-l-2 border-l-blue-700" : ""} px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white`}>
              <Link className="pt-5 pb-5" to="/admin/ViewItems">
                View Books
              </Link>
            </li>
          ...
          <ul>
            <li
              className={`mt-5 cursor-pointer block ${
                name == "ViewItems" ? "border-l-2 border-l-blue-700" : ""
            ...
            <li
              className={`mt-5 cursor-pointer block ${
                name == "AddItems" ? "border-l-2 border-l-blue-700" : ""
