...
import ViewLibrary from "../../../templates/library/ViewLibrary";
            ...
            >
              ...
              <div className="libraryTag flex flex-col justify-center items-center mt-2">
                ...
                <div className="actionButtons mt-2">
                  <a
                    href="#"
                    className="borrowBtn bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition-transform duration-300 ease-in-out transform hover:scale-105"
                    onClick={() => {
                      setShowModal(true);
