...
async function callback({ Client, Data, Database }: CommandExecuteArguments) {
  ...
  await Database.executeQuery("INSERT INTO books (title, author, barcode, language, year_of_prod, publisher, subjects, no_of_pages, price, rack, borrower, image) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)", [
    title,
    author,
    barcode,
    language,
